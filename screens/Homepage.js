  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'flex-start', marginHorizontal: 16, marginTop: 10 }}>
            <TouchableOpacity 
             style={[styles.quickActionItem, { marginRight: 12 }]}
               onPress={() => navigation.navigate('MapScreen')}
            >
            <View style={[styles.quickActionIcon, { backgroundColor: '#f0e6f2' }]}>
              <Icon name="map-outline" size={24} color="#3d0c45" />
            </View>
           ...
           <TouchableOpacity 
              style={styles.quickActionItem}
              onPress={() => navigation.navigate('AllRewardsScreen')}
           >
          <View style={[styles.quickActionIcon, { backgroundColor: '#fff5cc' }]}>
          <Icon name="gift-outline" size={24} color="#d79e00" />
      </View>
